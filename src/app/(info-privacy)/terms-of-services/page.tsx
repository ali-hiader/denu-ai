        ...
        <div className="flex flex-col items-center min-h-screen pt-6 sm:pt-0">
          ...
          <div className="w-full p-6 mt-6 overflow-hidden prose bg-white shadow-md sm:max-w-2xl sm:rounded-lg">
            ...
            <p className="mt-4">
              ...
              <a href="mailto:support@n8ked.app">support@n8ked.app</a>,
              providing details of the purchase and the reason for the request.
              Refunds will be processed through the original payment method,
              unless otherwise specified. We reserve the right to refuse refund
